Feature: Editing Leads functionality check in LeafTaps application
Scenario Outline: TC003_Editing multiple leads for positive functionality test
...
Scenario Outline: TC004_Editing lead without updating for positive functionality test
Given Click on the 'Find Leads' link
And Click on Phone tab
And Enter the Phone Number as <PhoneNumber>
And Click on Find lead button
